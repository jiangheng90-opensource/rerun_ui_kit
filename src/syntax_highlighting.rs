...
impl_sh_primitive!(f32, crate::format::format_f32);
impl_sh_primitive!(f64, crate::format::format_f64);

impl_sh_primitive!(i8, crate::format::format_int);
impl_sh_primitive!(i16, crate::format::format_int);
impl_sh_primitive!(i32, crate::format::format_int);
impl_sh_primitive!(i64, crate::format::format_int);
impl_sh_primitive!(isize, crate::format::format_int);
impl_sh_primitive!(u8, crate::format::format_uint);
impl_sh_primitive!(u16, crate::format::format_uint);
impl_sh_primitive!(u32, crate::format::format_uint);
impl_sh_primitive!(u64, crate::format::format_uint);
impl_sh_primitive!(usize, crate::format::format_uint);

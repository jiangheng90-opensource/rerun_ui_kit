use crate::time_types::{AbsoluteTimeRange, TimeType, TimestampFormat};
use crate::time_types::{TimeInt, TimeRange, TimeRangeBoundary};
    ...
    match boundary {
        TimeRangeBoundary::CursorRelative(value) => {
            ...
            let low_bound_override = if low_bound {
                Some(crate::time_types::TimeInt::MIN)
            } else {
...
mod tests {
    ...
    use crate::time_types::{TimeInt, TimeRange, TimeRangeBoundary};
    use crate::time_types::{TimeType, TimestampFormat};
        ...
        let mut harness = Harness::builder().build_ui(|ui| {
            ...
            ui.list_item_scope("test", |ui| {
                RelativeTimeRange {
                    ...
                    resolved_range: crate::time_types::AbsoluteTimeRange {
                        min: start,
                        max: end,
                    },
                    time_type,
    ...
    #[test]
    #[ignore = "snapshot reference images were not vendored from the rerun repo"]
    fn test_relative_time_range_ui() {
        ...
        for (time_type, time_range) in [
            ...
            (
                TimeType::DurationNs,
                crate::time_types::TimeInt::from_secs(0.0).as_i64()
                    ..=crate::time_types::TimeInt::from_secs(60.0).as_i64(),
            ),
            (

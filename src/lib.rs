...
//!
//! Vendored from re_ui 0.30.2 (<https://github.com/rerun-io/rerun>),
//! MIT OR Apache-2.0, with the rerun data stack removed.
...
fn format_with_decimals_in_range(
    ...
    fn format_with_decimals(value: f64, decimals: usize) -> String {
        crate::format::FloatFormatOptions::DEFAULT_f64
    ...
    if min_decimals < max_decimals {
        ...
        for decimals in min_decimals..max_decimals {
            ...
            if let Some(parsed) = crate::format::parse_f64(&text)

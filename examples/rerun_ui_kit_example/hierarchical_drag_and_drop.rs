...
use rerun_ui_kit::{DesignTokens, UiExt as _, list_item};
...
impl HierarchicalDragAndDrop {
    ...
    fn send_command(&self, command: Command) {
        ...
        self.command_sender.try_send(command).ok();
    }
}
...
impl HierarchicalDragAndDrop {
    ...
    fn handle_interaction(
        ...
        let item_desc = rerun_ui_kit::drag_and_drop::ItemContext {
            id: item_id,
            item_kind: if is_container {
                rerun_ui_kit::drag_and_drop::ItemKind::Container {
                    parent_id,
                    position_index_in_parent,
                }
            } else {
                rerun_ui_kit::drag_and_drop::ItemKind::Leaf {
                    parent_id,
                    position_index_in_parent,
                }
            },
        ...
        let drop_target = rerun_ui_kit::drag_and_drop::find_drop_target(
            ui,
            &item_desc,
            response.rect,

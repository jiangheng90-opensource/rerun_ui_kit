...
use rerun_ui_kit::{UiExt as _, list_item};
            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with icon")
                        .with_icon(&rerun_ui_kit::icons::VIEW_TEXT),
                );
                ...
                ui.list_item()
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("LabelContent with custom styling")
                            .subdued(true)
                            .italics(true)
                            .with_icon(&rerun_ui_kit::icons::VIEW_2D),
                    )
                ...
                ui.list_item()
                    .show_hierarchical(
                        ...
                        list_item::LabelContent::new("LabelContent with LabelStyle")
                            .label_style(rerun_ui_kit::LabelStyle::Unnamed)
                            .with_icon(&rerun_ui_kit::icons::VIEW_2D),
                    )
                ...
                ui.list_item().show_hierarchical(
                    ...
                    list_item::LabelContent::new("LabelContent with buttons").with_buttons(|ui| {
                        ui.small_icon_button(&rerun_ui_kit::icons::ADD, "Add");
                        ui.small_icon_button(&rerun_ui_kit::icons::REMOVE, "Remove");
                    }),
                );
                ...
                list_item::list_item_scope(ui, "inner_scope", |ui| {
                    ...
                    ui.list_item().show_hierarchical(
                        ...
                        list_item::PropertyContent::new("Color")
                            .with_icon(&rerun_ui_kit::icons::VIEW_TEXT)
                            .with_action_button(&rerun_ui_kit::icons::ADD, "Add", || {
        ...
        ui.list_item().show_hierarchical_with_children(
            ...
            |ui| {
                ...
                ui.list_item().show_hierarchical(
                    ...
                    .action_button(&rerun_ui_kit::icons::ADD, "Add", || {
                        log::warn!("Add button clicked");
                    }),
                );
            },
